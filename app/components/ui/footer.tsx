...
import gitlab from "@/src/assets/img/gitlab.svg"
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; {new Date().getFullYear()} Ne'matulloh – Barcha huquqlar himoyalangan.
            </div>
          </div>
          ...
          <div className="space-y-2 sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link className="text-gray-600 transition hover:text-gray-900" href="#projects">
                  Loyihalar
                </Link>
              </li>
              <li>
            ...
            <ul className="flex gap-1">
              ...
              <li>
                <Link
                  ...
                  href="https://gitlab.com/Nematullo_Nurmamatov"
                  target="_blank"
                  aria-label="GitLab"
                >
                  {/* <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <path d="M18 34L7 11H0l18 25 18-25h-7l-11 23Z" />
                    <path d="M18 34L25 11h-5.5L18 20.5 16.5 11H11l7 23Z" />
                  </svg> */}

                </Link>
                <Image  className="rounded-full w-5  !mt-1" src={gitlab} alt="gitlab" width={40} height={40} />
              </li>
            </ul>
          </div>
        </div>
